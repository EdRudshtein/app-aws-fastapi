...
from .models import Comment, Dog, Image, Post, SessionLocal, User
from .routers import auth, comments, dogs, posts
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[os.getenv("API_URL") or ""],  # The default React port
